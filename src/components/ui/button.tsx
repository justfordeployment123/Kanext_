  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-semibold transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-gold text-black font-bold hover:scale-105 hover:shadow-[0_0_30px_hsl(43_74%_53%/0.5)] transition-all duration-300",
        "hero-secondary": "bg-transparent text-gold border-2 border-gold font-bold hover:bg-gold/10 hover:scale-105 transition-all duration-300",
        gold: "bg-gold text-black hover:bg-gold/90 shadow-[0_0_20px_hsl(43_74%_53%/0.3)]",
      },
      size: {
